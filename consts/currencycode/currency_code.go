...
const (
	...
	GBP = "GBP" // 英镑 (British Pound Sterling)
	AUD = "AUD" // 澳大利亚元 (Australian Dollar)
	CAD = "CAD" // 加拿大元 (Canadian Dollar)
	CHF = "CHF" // 瑞士法郎 (Swiss Franc)
	HKD = "HKD" // 港币 (Hong Kong Dollar)
	TWD = "TWD" // 新台币 (Taiwan Dollar)
	KRW = "KRW" // 韩元 (Korean Won)
	...
	AED = "AED" // 阿联酋迪拉姆 (UAE Dirham)
	SAR = "SAR" // 沙特里亚尔 (Saudi Riyal)
	BRL = "BRL" // 巴西雷亚尔 (Brazilian Real)
	IDR = "IDR" // 印尼盾 (Indonesian Rupiah)
	...
	DKK = "DKK" // 丹麦克朗 (Danish Krone)
	PLN = "PLN" // 波兰兹罗提 (Polish Złoty)
	TRY = "TRY" // 土耳其里拉 (Turkish Lira)
	VND = "VND" // 越南盾 (Vietnamese Dong)
