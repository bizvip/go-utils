...
// 	endpoint   = ini.Cfg.Hwc.Endpoint
// 	ak         = ini.Cfg.Hwc.Ak
// 	sk         = ini.Cfg.Hwc.Sk
// 	bucketName = ini.Cfg.Hwc.BucketName
// 	objectKey  = "test"
// )
//
...
// 			fmt.Printf(
// 				"Content[%d]-OwnerId:%s, OwnerName:%s, ETag:%s, Key:%s, LastModified:%s, Size:%d, StorageClass:%s\n",
// 				index,
// 				val.Owner.ID,
...
// 			fmt.Printf(
// 				"Version[%d]-OwnerId:%s, OwnerName:%s, ETag:%s, Key:%s, VersionId:%s, LastModified:%s, Size:%d, StorageClass:%s\n",
// 				index,
// 				val.Owner.ID,
// 				val.Owner.DisplayName,
// 				val.ETag,
...
// 			fmt.Printf(
// 				"DeleteMarker[%d]-OwnerId:%s, OwnerName:%s, Key:%s, VersionId:%s, LastModified:%s, StorageClass:%s\n",
// 				index,
// 				val.Owner.ID,
// 				val.Owner.DisplayName,
// 				val.Key,
...
// 			fmt.Printf(
// 				"Grant[%d]-Type:%s, ID:%s, URI:%s, Permission:%s\n",
// 				index,
// 				grant.Grantee.Type,
// 				grant.Grantee.ID,
// 				grant.Grantee.URI,
...
// 			fmt.Printf(
// 				"ID:%s, AllowedOrigin:%s, AllowedMethod:%s, AllowedHeader:%s, MaxAgeSeconds:%d, ExposeHeader:%s\n",
// 				corsRule.ID,
// 				strings.Join(corsRule.AllowedOrigin, "|"),
// 				strings.Join(corsRule.AllowedMethod, "|"),
// 				strings.Join(corsRule.AllowedHeader, "|"),
// 				corsRule.MaxAgeSeconds,
// 				strings.Join(corsRule.ExposeHeader, "|"),
// 			)
// 		}
// 	} else {
// 		if obsError, ok := err.(obs.ObsError); ok {
...
// 		fmt.Printf("StatusCode:%d, RequestId:%s\n", output.StatusCode, output.RequestId)
// 		fmt.Printf(
// 			"RedirectAllRequestsTo.HostName:%s,RedirectAllRequestsTo.Protocol:%s\n",
// 			output.RedirectAllRequestsTo.HostName,
...
// 			fmt.Printf(
// 				"Condition[%d]-KeyPrefixEquals:%s, HttpErrorCodeReturnedEquals:%s\n",
// 				index,
// 				routingRule.Condition.KeyPrefixEquals,
// 				routingRule.Condition.HttpErrorCodeReturnedEquals,
// 			)
// 			fmt.Printf(
// 				"Redirect[%d]-Protocol:%s, HostName:%s, ReplaceKeyPrefixWith:%s, HttpRedirectCode:%s\n",
// 				index,
...
// 				}
// 				fmt.Printf(
// 					"transition.StorageClass:%s, Transition.Date:%s, Transition.Days:%d\n",
...
// 			}
// 			fmt.Printf(
// 				"Expiration.Date:%s, Expiration.Days:%d\n",
...
// 				fmt.Printf(
// 					"noncurrentVersionTransition.StorageClass:%s, noncurrentVersionTransition.NoncurrentDays:%d\n",
...
// 			fmt.Printf(
// 				"index[%d], DomainName:%s, CreateTime:%s\n",
// 				index,
// 				domain.DomainName,
// 				domain.CreateTime,
// 			)
...
// 			fmt.Printf(
// 				"Upload[%d]-OwnerId:%s, OwnerName:%s, UploadId:%s, Key:%s, Initiated:%s,StorageClass:%s\n",
// 				index,
// 				upload.Owner.ID,
...
// 		fmt.Printf("StatusCode:%d, RequestId:%s\n", output.StatusCode, output.RequestId)
// 		fmt.Printf(
// 			"StorageClass:%s, ETag:%s, ContentType:%s, ContentLength:%d, LastModified:%s\n",
// 			output.StorageClass,
// 			output.ETag,
// 			output.ContentType,
// 			output.ContentLength,
...
// 			fmt.Printf(
// 				"Part[%d]-ETag:%s, PartNumber:%d, LastModified:%s, Size:%d\n", index, part.ETag,
...
// 		fmt.Printf("StatusCode:%d, RequestId:%s\n", output.StatusCode, output.RequestId)
// 		fmt.Printf(
// 			"Location:%s, Bucket:%s, Key:%s, ETag:%s\n",
// 			output.Location,
// 			output.Bucket,
// 			output.Key,
// 			output.ETag,
